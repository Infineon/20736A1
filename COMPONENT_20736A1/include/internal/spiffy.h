...
#elif  defined(BCM20733)
#define SPIFFY_TX_FIFO_LEN      64
#define SPIFFY_RX_FIFO_LEN      64
#endif
...
#if defined (BCM4314) || defined (BCM4334) || defined (BCM43341) || defined SPIFFY_16BYTE_FIFO || defined(BCM43242)

...
enum
{
    ...
    CONTROL_ENABLE                     = 0x01,
    HW_CTRL_QUAD_INTERRUPT_ENABLE      = 0x02,
...
/// \param x Pointer to previously accumulated motion in X axis.
/// \param y Pointer to previously accumulated motion in Y axis.
...
/// \param userfn Pointer to the callback function.
/// \param data A pointer to a user provided context that will be passed back to the callback.

...
/*! @{ */
/**
* Defines a MIA driver. Applications use this
...
/*! @{ */
/**
* Defines the miadriver class. Mia driver class encapsulates the mia clock freeze

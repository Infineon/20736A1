...
/** @file
*
* This file provides definitions and function prototypes for the Blueooth LE
* GATT profiles
*
*/
...
/**
* \brief Bluetooth LE Profile Configuration
* \ingroup bleprofile
*
...
/**
* \brief Initialize Blueooth LE profile
* \ingroup bleprofile
*
* \details This function is the main profile common library initialization.  Application must call
* this function during blexxxx_Create. The function registers profile with the stack,
...
#ifdef BLEPROFILE_ADDL_API_SUPPORTED
/**
* \brief Check NVRAM
* \ingroup bleprofile
*
...
* event can disconnect the Bluetooth LE connection.
*
...
* request a set of new connection parameters.  During connection establishment
* and initial data exchange central typically sets parameters requiring very fast
...
* \param peripheralLatency Defines the peripheral latency parameter (as number of LL connection events).
...
void bleprofile_SendConnParamUpdateReq(UINT16 minInterval, UINT16 maxInterval,
                                       UINT16 peripheralLatency, UINT16 timeout);

...
################################################################################
#
# all apps need bleapp_lib patches installed
#
CY_20736A1_APP_PATCH_LIBS += bleapp_lib.a

#
# floating point and other device specific compiler flags
#
CY_CORE_CFLAGS+=-mfloat-abi=soft
CY_CORE_EXTRA_LD_FLAGS+=-mfloat-abi=soft
CY_RECIPE_EXTRA_LIBS+=-lgcc

DIRECT_LOAD?=0
# Flash Base address
CY_CORE_CGS_ARGS+=-A $(CY_FLASH0_BEGIN_ADDR)
...
CY_CORE_APP_CHIPLOAD_FLAGS+=-NODLMINIDRIVER
...
# disable until these can work for this device

...
void wdog_configure(BOOL32 Active);
...
//  *((volatile unsigned char *)0x200CF1)=0; // -- to disable sleep ?? not using for now
//  6683: 00200cec     7 OBJECT  GLOBAL HIDDEN     9 pmu_sleepModeConfig
//
